...
export default function (Replicator, desc) {
  describe(`${desc} - optimistic mutation online`, () => {
    ...
    describe('not connected', () => {
      ...
      it('create fails', () => clientService.create({ id: 99, uuid: 1099, order: 99 })
        .then(() => {
    ...
    describe('without publication', () => {
      ...
      it('find works', () => replicator.connect()
      ...
      it('get works', () => replicator.connect()
      ...
      it('create adds missing uuid', () => replicator.connect()
    ...
    describe('without publication & remote error', () => {
      ...
      it('get fails correctly', () => replicator.connect()
      ...
      it('create recovers', () => replicator.connect()
      ...
      it('update recovers', () => replicator.connect()
      ...
      it('patch recovers', () => replicator.connect()
      ...
      it('remove recovers', () => replicator.connect()
